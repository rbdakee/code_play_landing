    ...
    sections: [
      {
        ...
        paragraphs: [
          "Настоящая Политика конфиденциальности описывает, как сайт Code Play обрабатывает информацию пользователей при посещении сайта и при обращении за консультацией или записью на пробный урок.",
          "Сайт Code Play предназначен для информирования родителей и законных представителей о курсах программирования для детей в возрасте от 7 до 16 лет.",
        ],
      },
      {
        title: "2. Кто обрабатывает данные",
        paragraphs: [
          "Оператором данных в рамках настоящей Политики является администрация проекта Code Play.",
          "Поскольку на сайте не указаны отдельные реквизиты юридического лица или индивидуального предпринимателя, в настоящем документе используется обозначение \"Code Play\" или \"администрация сайта\".",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Code Play не продаёт и не передаёт персональные данные третьим лицам для их самостоятельного маркетинга.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Code Play просит не передавать персональные данные ребёнка в объёме, превышающем разумно необходимый для подбора курса или записи на пробный урок.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          "This Privacy Policy describes how the Code Play website processes user information when visiting the site and when requesting a consultation or booking a trial lesson.",
          "The Code Play website is intended to inform parents and legal guardians about programming courses for children aged 7 to 16.",
        ],
      },
      {
        title: "2. Who Processes the Data",
        paragraphs: [
          "The data controller under this Policy is the administration of the Code Play project.",
          "Since the website does not currently list the separate legal details of a company or sole proprietor, this document uses the designation \"Code Play\" or \"site administration\".",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Code Play does not sell or transfer personal data to third parties for their independent marketing purposes.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Code Play asks users not to provide a child's personal data beyond what is reasonably necessary to select a course or arrange a trial lesson.",
        ],
      },
      {
        title: "8. User Rights",
    ...
    sections: [
      {
        title: "1. Общие положения",
        paragraphs: [
          "Настоящие Условия использования регулируют порядок использования сайта Code Play, размещённого в сети Интернет, а также материалов и информации, опубликованных на нём.",
      ...
      },
      {
        ...
        paragraphs: ["Сайт Code Play носит информационный характер и предназначен для:"],
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          "использовать материалы сайта способом, нарушающим права Code Play или третьих лиц.",
        ],
      },
      {
        title: "4. Интеллектуальная собственность",
        paragraphs: [
          "Все тексты, изображения, логотипы, элементы дизайна, структура сайта и иные материалы, размещённые на сайте, принадлежат Code Play либо используются на законных основаниях.",
      ...
      },
      {
        ...
        paragraphs: [
          "Code Play вправе в любое время изменять настоящие Условия использования. Актуальная версия вступает в силу с момента публикации на сайте или в документах проекта.",
        ],
      },
      {
        title: "7. Контакты",
    ...
    sections: [
      {
        title: "1. General Provisions",
        paragraphs: [
          "These Terms of Use govern the use of the Code Play website and the materials and information published on it.",
          "By using the website, you confirm that you have read and accepted these Terms in full.",
        ],
      },
      {
        title: "2. Purpose of the Website",
        paragraphs: ["The Code Play website is intended for:"],
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          "use website materials in a way that infringes the rights of Code Play or third parties.",
        ],
      },
      {
        title: "4. Intellectual Property",
        paragraphs: [
          "All texts, images, logos, design elements, website structure, and other materials published on the website belong to Code Play or are used on a lawful basis.",
      ...
      },
      {
        ...
        paragraphs: [
          "Code Play may update these Terms of Use at any time. The current version takes effect from the moment it is published on the website or in the project documents.",
        ],
      },
      {
        title: "7. Contacts",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Оставляя обращение через доступные каналы связи Code Play, включая переход по ссылке в WhatsApp, отправку сообщения в мессенджере или иное добровольное предоставление своих данных, пользователь выражает согласие на обработку персональных данных на условиях, изложенных ниже.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: ["Code Play вправе осуществлять с персональными данными:"],
        items: [
      ...
      },
      {
        ...
        paragraphs: [
          "Данные могут быть доступны техническим подрядчикам, сервисам связи и мессенджерам, через которые пользователь самостоятельно обращается к Code Play, а также государственным органам в случаях, предусмотренных законом.",
      ...
      },
      {
        ...
        paragraphs: [
          "Пользователь может отозвать согласие, направив сообщение через доступные контактные каналы Code Play.",
        ],
      },
      {
        title: "7. Контакты",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "By contacting Code Play through the available communication channels, including following a WhatsApp link, sending a message in a messenger, or otherwise voluntarily providing personal information, the user gives consent to the processing of personal data under the terms set out below.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: ["Code Play may perform the following actions with personal data:"],
        items: [
      ...
      },
      {
        ...
        paragraphs: [
          "Data may be accessible to technical contractors, communication services and messengers used by the user to contact Code Play, and public authorities where required by law.",
      ...
      },
      {
        ...
        paragraphs: [
          "The user may withdraw consent by sending a message through the available Code Play contact channels.",
        ],
      },
      {
        title: "7. Contacts",
